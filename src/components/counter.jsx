...
const Counter = (props) => {
    ...
    const handleIncrement = () => { // ну это не обязательно 
    ...
    return (
        <div>
            ...
            <button className='btn btn-primary btn-sm m-2' onClick={() => props.onIncrement(props.id)}>+</button> // так тоже пойдет, но луче 
